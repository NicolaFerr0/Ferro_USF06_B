    ...
    Boolean readLoop(BufferedReader in, PrintWriter out) {
        ...
        try {
            while((s = in.readLine()) != null) {
                ...
                } else if (s.equals("sorted_by_price")) {
                    Cantina.getInstance().sendAllWinesSortedPrice(out);
                }
                else if (s.equals("red")) {
                    out.println(Cantina.getInstance().sendAllRedWines());
                }
                else if (s.equals("white")) {
                    out.println(Cantina.getInstance().sendAllWhiteWines());
                }
